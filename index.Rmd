...
# download the partitions you require from Dfam 3.9. We will just pick 0 and 16
wget https://dfam.org/releases/current/families/FamDB/dfam39_full.0.h5.gz
wget https://dfam.org/releases/current/families/FamDB/dfam39_full.16.h5.gz
...
earlGrey -g $GENOME -t 30 -s Afum-strain -o $OUTDIR/$PREFIX -r eukarya -c yes -d yes -e yes
```
